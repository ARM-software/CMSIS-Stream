...
new_graph = import_graph("graph.yml",{"MyFIFO":MyFIFO})
export_graph(new_graph,"graph2.yml")


# Compute a static scheduling of the graph 
# The size of FIFO is also computed

with open("pre_schedule_customfifo.dot","w") as f:
...
with open("customfifo.dot","w") as f:
