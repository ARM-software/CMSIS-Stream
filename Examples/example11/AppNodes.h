...
class ProcessingOddEven<int16_t,1,
                        ...
                        int16_t,1,
                        int16_t,1>: 
public GenericNode31<int16_t,1,
                     int16_t,1,
                     int16_t,1,
                     int16_t,1>
{
public:
    ProcessingOddEven(FIFOBase<int16_t> &srcOdd,
                      ...
                      FIFOBase<int16_t> &srcOther,
                      FIFOBase<int16_t> &dst):
    GenericNode31<int16_t,1,
                  int16_t,1,
                  int16_t,1,
                  int16_t,1>(srcOdd,srcEven,srcOther,dst){};
    ...
    int run()  override{
        ...
        {
            int16_t *other=this->getReadBuffer3();
        }
