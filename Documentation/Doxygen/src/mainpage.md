@mainpage CMSIS-Stream Platform Runtime API
...
documents the platform and CMSIS-RTOS runtime API generated from the source
headers.

The full CMSIS-Stream documentation, including the Python and C/C++ framework
guides, lives as Markdown files in the official GitHub repository:
https://github.com/ARM-software/CMSIS-Stream/

To use the CMSIS-Stream runtime, Python is used to describe the graph of
processing components and generate the state machine that schedules it.
