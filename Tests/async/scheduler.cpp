    ...
    while((cgStaticError==0) && (debugCounter > 0))
    {
        ...
        for(unsigned long id=0 ; id < 184; id++)
        {
            ...
            switch(schedule[id])
            {
                case 0:
                {
                    cgStaticError = dstaA.prepareForRunning();
                }
                break;

                case 1:
                {
                    cgStaticError = dstaB.prepareForRunning();
                }
                break;

                case 2:
                {
                    cgStaticError = dstaC.prepareForRunning();
                }
                break;

                case 3:
                {
                    cgStaticError = dstbA.prepareForRunning();
                }
                break;

                case 4:
                {
                    cgStaticError = dstbB.prepareForRunning();
                }
                break;
                ...
                case 7:
                {
                    cgStaticError = dup2.prepareForRunning();
                }
                break;

                case 8:
                {
                    cgStaticError = dup3.prepareForRunning();
                }
                break;

                case 9:
                {
                    cgStaticError = dup4.prepareForRunning();
                }
                break;
                ...
                case 19:
                {
                    cgStaticError = proc_f_m.prepareForRunning();
                }
                break;

                case 20:
                {
                    cgStaticError = proc_m_to_m.prepareForRunning();
                }
                break;

                case 21:
                {
                    cgStaticError = proc_to_m.prepareForRunning();
                }
                break;
                ...
                case 28:
                {
                    cgStaticError = src0.prepareForRunning();
                }
                break;

                case 29:
                {
                    cgStaticError = src1.prepareForRunning();
                }
                break;
