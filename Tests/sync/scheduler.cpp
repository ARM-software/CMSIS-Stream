...
uint32_t scheduler(int *error,void *evtQueue_)
{
    ...
    */
    ...
    FIFO<float,FIFOSIZE7,1,0> fifo7(buf7);
    FIFO<float,FIFOSIZE8,1,0> fifo8(buf8);
    FIFO<float,FIFOSIZE9,1,0> fifo9(buf9);
    FIFO<float,FIFOSIZE10,1,0> fifo10(buf10);
    FIFO<float,FIFOSIZE11,1,0> fifo11(buf11);
    FIFO<float,FIFOSIZE12,1,0> fifo12(buf12);
    FIFO<float,FIFOSIZE13,1,0> fifo13(buf13);
    FIFO<float,FIFOSIZE14,1,0> fifo14(buf14);
    FIFO<float,FIFOSIZE15,1,0> fifo15(buf15);
    FIFO<float,FIFOSIZE16,1,0> fifo16(buf16);
    FIFO<float,FIFOSIZE17,0,0> fifo17(buf17);
    FIFO<float,FIFOSIZE18,0,0> fifo18(buf18);
    FIFO<float,FIFOSIZE19,1,0> fifo19(buf19);
    FIFO<float,FIFOSIZE20,1,0> fifo20(buf20);
    FIFO<float,FIFOSIZE21,0,0> fifo21(buf21);
    FIFO<float,FIFOSIZE22,1,0> fifo22(buf22);
    FIFO<float,FIFOSIZE23,1,0> fifo23(buf23);
    FIFO<float,FIFOSIZE24,1,0> fifo24(buf24);
    FIFO<float,FIFOSIZE25,1,0> fifo25(buf25);
    FIFO<float,FIFOSIZE26,1,0> fifo26(buf26);
    FIFO<float,FIFOSIZE27,1,0> fifo27(buf27);
    FIFO<float,FIFOSIZE28,1,0> fifo28(buf28);
    FIFO<float,FIFOSIZE29,1,0> fifo29(buf29);
    FIFO<float,FIFOSIZE30,1,0> fifo30(buf30);
    FIFO<float,FIFOSIZE31,1,0> fifo31(buf31);
    FIFO<float,FIFOSIZE32,1,0> fifo32(buf32);
